...
public class hooks {
    ...
    static final String kikConversationFragment = "kik.android.chat.fragment.KikConversationsFragment";
    static final String kikPKG = "kik.android";
    static final String kABSTRACT_MESSAGE_VIEW_MODEL = "kik.android.chat.vm.messaging.AbstractMessageViewModel";
    static final String kikReceiptParser = "kik.core.net.g";
    static final String kikChatFragment = "kik.android.chat.fragment.KikChatFragment";
